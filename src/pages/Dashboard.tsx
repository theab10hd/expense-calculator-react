...
const TransactionCard = ({
  ...
  return (
    <div className="flex justify-between items-center p-4 bg-white/10 rounded-lg  mb-2">
...
const CategoryCard = ({ category }: { category: CategoryType }) => {
  ...
  return (
    <div className="w-full h-full group flex-col  justify-start items-center glassmorphism glassmorphism-hover p-4 hover:scale-102 cursor-pointer ease-in-out transition-all duration-300">
...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 relative text-white ">
      ...
      <div className="grid grid-rows-none auto-rows-auto mt-4 gap-4">
        {/* Total Balance */}
        <div className="row-span-1 grid grid-cols-4 gap-4 w-full">
          <div className="-full h-full flex flex-col justify-start items-center glassmorphism p-8">
          ...
          <div className=" w-full h-full flex flex-col justify-start items-center glassmorphism p-8">
        ...
        <div className="row-span-2  grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            laudantium culpa ullam minus consequuntur inventore harum dolores
            quos nam dolore, sapiente voluptates dolorum, necessitatibus totam
            sint natus maiores tempore vel!
          </div>
        </div>
      </div>
    </div>
